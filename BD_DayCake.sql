...
INSERT INTO Produto(nome, descricao, preco, tempo_preparo, status) VALUES
('Bolo', 'Com massa branca ou massa de chocolate e um recheio da escolha do cliente', '65.00', '03:00', 'ativo'),
('Torta de Limão', 'Torta com recheio de limão e merengue', '45.00', '01:30', 'inativo'),
('Cupcakes', '	Caixa com 6 unidades', '48.00', '01:00', 'ativo'),
('Palha Italiana Gourmet', 'Feita com chocolate belga', '25.00', '01:00', 'ativo'),
('Bolo no Pote', 'Sabores variados (ninho com morango morango, nutella, brigadeiro)', '12.00', '00:40', 'inativo'),
('Bolo Red Velvet', 'Massa de cacau com cream cheese', '70.00', '02:30', 'ativo'),
('Brigadeiro', 'Feito com leite condensado, chocolate e coberto com granulado.', '2.00', '01:20', 'ativo'),
('Brigadeiro Gourmet', 'Chocolate belga, granulado belga, recheios, etc.) e decoração diferenciada.', '4.00', '01:40', 'inativo'),
('Cheesecake de Frutas Vermelhas', 'Cheesecake com calda natural', '55.00', '02:00', 'ativo');
...
INSERT INTO Pedido(clienteid, data_pedido, data_entrega, valor, tipo_de_doce, descricao, forma_pagamento, status) VALUES
(1, '2025-04-01', '2025-04-03', 65.00, 'Bolo e Brigadeiro', '2kg de Bolo e 100 brigadeiros. Entregar após as 14h', 'PIX', 'Em andamento'),
(3, '2025-04-10', '2025-04-19', 45.00,'Cupcakes', 'Caixa com 6 sabores sortidos. Tema “Unicórnio” para decoração', 'Débito', 'Entregue'),
(5, '2025-04-13', '2025-04-15', 32.00,'Torta de Limão', 'Entregar até as 12h', 'Dinheiro', 'Finalizado'),
(2, '2025-04-14', '2025-04-16', 70.00,'Bolo Red Velvet e Bolo no Pote','1 kg de bolo red velver e 2 bolos de pote de ninho com morango', 'Cartão de Crédito', 'Cancelado'),
(8, '2025-04-12', '2025-04-13', 80.00,'Bolo e Brigadeiro Gourmet', '3kg Bolo com massa branca, recheio de ninho e 30und de Brigadeiro Gourmet. Tema: casamento civil. Usar fitas brancas nas embalagens.', 'PIX', 'Cancelado');
